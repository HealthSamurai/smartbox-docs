...
{% hint style="info" %}
Aidbox supports [registering SMART applications](https://docs.aidbox.app/docs/aidbox/access-control/authorization/smart-on-fhir/smart-client-authorization/smart-app-launch#register-smart-client)
{% endhint %}

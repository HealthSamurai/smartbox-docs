...
{% hint style="info" %}
Aidbox supports [registering SMART applications](https://www.health-samurai.io/docs/aidbox/access-control/authorization/smart-on-fhir/smart-client-authorization/smart-app-launch#register-smart-client)
{% endhint %}
